...
namespace Magnetizing_FPG
{
    ...
    public class RoomInstanceAttributes : GH_ComponentAttributes, IRoomStructure<IGH_DocumentObject>
    {
        ...
        public GH_Capsule RoomAspectRatio;


        Rectangle RoomAreaRectangle;
        Rectangle RoomNameRectangle;
        Rectangle RoomAspectRatioRectangle;
        ...
        const int OuterComponentRadius = 85; // Used to define the radius of the main circle
        ...
        protected override void Render(GH_Canvas canvas, Graphics graphics, GH_CanvasChannel channel)
        {
            if (Owner is RoomInstance roomInstance)
                if (channel == GH_CanvasChannel.Objects)
                {
                    ...
                    RoomAspectRatioRectangle = new Rectangle(new System.Drawing.Point((int)Bounds.Location.X + 65, (int)Bounds.Location.Y + 105), new Size(57, 20));
                    ...
                    //aspect ratio label
                    graphics.DrawString("AR :", SystemFonts.IconTitleFont, Brushes.Black, new RectangleF(new System.Drawing.Point((int)Bounds.Location.X + 35, (int)Bounds.Location.Y + 106), new Size(30, 20)));
                    ...
                    RoomAspectRatio = GH_Capsule.CreateTextCapsule(RoomAspectRatioRectangle, InflateRect(RoomAspectRatioRectangle, InflateAmount, InflateAmount), GH_Palette.Pink, roomInstance.RoomAspectRatio.ToString());
                    RoomAspectRatio.Render(graphics, GH_Skin.palette_white_standard);
                    RoomAspectRatio.Dispose();
        ...
        public override GH_ObjectResponse RespondToMouseDoubleClick(GH_Canvas sender, GH_CanvasMouseEvent e)
        {
            if (Owner is RoomInstance roomInstance)
            {
                ...
                if (this.RoomAspectRatio.Contains(e.CanvasLocation))
                {
                    var field = new CapsuleInputBase(RoomAspectRatio, roomInstance, RoomInstanceVar.RoomAspectRatio)
                    {
                        Bounds = GH_Convert.ToRectangle(RoomAspectRatio.Box)
                    };
                    field.ShowTextInputBox(sender, RoomAspectRatio.Text, true, false, matrix);
                }
   ...
   */
            ...
            writer.SetBoolean("useAR", (Owner as RoomInstance).useAspectRatio);
            writer.SetDouble("RoomAspectRatio", (Owner as RoomInstance).RoomAspectRatio);
        ...
        public override bool Read(GH_IO.Serialization.GH_IReader reader)
        {
            ...
            (Owner as RoomInstance).RoomAspectRatio = (int)Math.Floor(reader.GetDouble("RoomAspectRatio"));//, (Owner as RoomInstance).RoomAspectRatio);
            ...
            try
            {
                (Owner as RoomInstance).useAspectRatio = reader.GetBoolean("useAR");
            }
            catch (Exception e) { }
    ...
    public enum RoomInstanceVar { RoomName, RoomArea, RoomAspectRatio };
        ...
        protected override void HandleTextInputAccepted(string text)
        {
            ...
            switch (_roomInstanceVar)
            {
                ...
                case (RoomInstanceVar.RoomArea):
                    _roomInstance.RoomArea = Double.Parse(text);
                    break;
                case (RoomInstanceVar.RoomAspectRatio):
                    _roomInstance.RoomAspectRatio = Double.Parse(text);
                    break;
            }
