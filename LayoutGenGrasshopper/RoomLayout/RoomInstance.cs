...
using LayoutGenGrasshopper.Properties;
...
namespace Magnetizing_FPG
{
    ...
    public class RoomInstance : GH_Component
    {
        ...
        public double RoomAspectRatio = 1;
        public bool useAspectRatio = false; //whether or not to enforce the aspect ratio for a room
        ...
        protected override void AppendAdditionalComponentMenuItems(ToolStripDropDown menu)
        {
            ...
            Menu_AppendItem(menu, "Enforce Aspect Ratio", Menu_SetUseAR, true, useAspectRatio);
        ...
        private void Menu_SetUseAR(object sender, EventArgs e)
        {
